 ...
 */
Doorbell_Basic::Doorbell_Basic(std::string name, uint8_t pin, bool default_state) : Doorbell(std::move(name)),
    switch_pin_(pin),
...
void Doorbell_Basic::executeCharacteristicUpdate(gadget_definitions::CharacteristicIdentifier characteristic,
                                                 uint16_t step_value) {
}
